...
export const post: Post = {
    ...
    body: [
      ...
      },
      {
        ...
        body: `Multnomah Village's 1955–1970 ranch and split-level stock is in heavy re-roofing demand. These homes typically have larger-than-average roof areas relative to living space due to their low-pitch designs, and many are now on their second or third asphalt replacement.\n\nThe good news for Multnomah homeowners is that the neighborhood sits outside any historic overlay and contractor access is straightforward. Lead times are running 4–5 weeks, elevated but not as stretched as Sellwood or Irvington.`,
      },
      {
        heading: '4. Alameda: Wind Damage From February Event Driving Inspections',
        body: `The February 2026 wind event, 58 mph gusts recorded at the Alameda Ridge weather station, left a significant number of Alameda homes with wind-seal failures that aren't visible from the ground. Insurance-driven inspections and subsequent replacement quotes have been running at elevated levels since early March.\n\nAlameda's elevated permit difficulty (score 4/5) and the neighborhood's preference for premium materials (cedar shake and metal dominate) mean average project values are high and specialist contractor capacity is the binding constraint. Expect 6–8 week lead times for full replacements.`,
      },
      {
        heading: '5. Beaverton: Volume Market Hitting Capacity',
        body: `Beaverton is a different story from the inner Portland neighborhoods above. It's not historic overlay or premium materials, it's sheer volume. The city's large 1980s and 1990s suburban housing stock is entering a synchronized re-roofing cycle, and Washington County's contractor pool is stretched.\n\nBeaverton replacements are lower in per-project value (median $8,600) but high in volume. Straightforward Washington County permits, accessible locations, and standard asphalt specs mean jobs move faster, but there are simply a lot of them. Lead times are running 3–4 weeks, shorter than inner Portland but up significantly from last year's 1–2 week norm.`,
      },
      {
        body: `If your neighborhood appears on this list and you've been putting off getting quotes, the practical advice is simple: contact three contractors now, before you need the work done urgently. Emergency scheduling, active leak, visible storm damage, always gets prioritized, but it also costs more and limits your choice of contractor. The best time to get on a good contractor's schedule is before you need to.`,
      },
    ],
  }
