...
export const post: Post = {
    slug:      'do-you-need-a-permit-to-replace-a-roof-in-portland',
    title:     'Do You Need a Permit to Replace a Roof in Portland?',
    excerpt:   `Most full roof replacements in Portland need a building permit, and your licensed CCB contractor should pull it, not you. What triggers a permit, who is on the hook, and the real cost of unpermitted roofing work.`,
    category:  'contractor',
    tags:      ['permits', 'portland', 'oregon', 'roof replacement', 'hiring'],
