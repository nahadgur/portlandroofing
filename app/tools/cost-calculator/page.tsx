...
export const metadata: Metadata = {
  title: `Portland Roof Cost Calculator â€” Local Cost Drivers & Line-Item Breakdown`,
...
const faqs = [
  { question: 'How accurate is this Portland roof cost calculator?', answer: 'More accurate than national calculators because it routes your ZIP to the closest of 10 PDX cost markets and applies that market\'s specific cost drivers. Pre-1925 Hawthorne Craftsmans automatically include skip-sheathed deck overlay; West Hills addresses include steep-pitch labor premium and crane staging; historic district properties include design review fees. Range reflects typical 20% contractor variance on identical scope.' },
  { question: 'Why does the calculator add a deck repair allowance based on roof age?', answer: 'Pre-1970 Portland homes frequently have skip-sheathed decks (1Ã, 4 boards with gaps) that require full plywood overlay before modern shingles can be installed. 1980s-1990s homes have CDX plywood that delaminates under sustained moss in canopied neighborhoods. The age-based allowance reflects what a reputable Portland contractor would build into a quote pre-bid; ones that don\'t are setting up a change order.' },
  { question: 'Why does my West Hills quote include crane staging?', answer: 'Steep hillside lots in Council Crest, Forest Park, and West Hills frequently have driveway access on one side only, with upper-roof areas inaccessible from ground-level material staging. Crane day adds $1,400-$3,500 but is meaningfully cheaper than manually carrying material up steep slopes â€” and OSHA fall-protection requirements make manual staging legally questionable on 10:12+ pitches.' },
  ...
  return (
    <>
      ...
      <PageHero
        ...
        eyebrow="Tool 01 Â· Free"
        title={<>ROOF COST<br /><span style={{ color: '#F5A623' }}>CALCULATOR</span></>}
        subtitle="Estimate your Portland roof replacement cost with line-item breakdown. ZIP routing detects the closest cost market and applies neighborhood-specific drivers â€” deck repair allowance, ventilation upgrade, permit fee, design review where applicable."
      />
