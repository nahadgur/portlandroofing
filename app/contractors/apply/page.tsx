...
export const metadata: Metadata = {
  title:`Join the Portland Roofing Contractor Network`,
  ...
  return (
    <>
      ...
      <PageHero
        ...
        subtitle="We rank for roofing searches across Portland's 10 deepest cost markets. The leads are coming in. We're vetting contractors to fill the listed slots â€” and only the top 1% pass."
      ...
      <div style={{background:'var(--bg2)',borderTop:'1px solid var(--bdr)',padding:'2rem 3rem',display:'flex',justifyContent:'space-between',alignItems:'center',flexWrap:'wrap',gap:'1rem'}}>
        ...
        <Link href="/contractors/vetting" style={{...c,fontSize:'0.85rem',fontWeight:700,color:'var(--amber)',textDecoration:'none',letterSpacing:'0.08em',textTransform:'uppercase'}}>See All 47 Vetting Checkpoints â†’</Link>
      </div>
      <Footer />
    </>
  )
