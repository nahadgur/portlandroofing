...
import { postCategoryLabels, postCategoryColors } from '@/lib/posts'
    ...
    <>
      ...
      <section className="section-pad" style={{ background:'var(--bg)' }}>
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-end', marginBottom:'2rem', flexWrap:'wrap', gap:'1rem' }}>
          ...
          <Link href="/guides" style={{ fontFamily:'var(--font-barlow-cond)', fontSize:'0.85rem', color:'var(--amber)', textDecoration:'none', letterSpacing:'0.06em', whiteSpace:'nowrap' }}>
            All Guides →
          </Link>
        </div>
      ...
      <section className="section-pad" style={{ background:'var(--bg2)' }}>
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-end', marginBottom:'2rem', flexWrap:'wrap', gap:'1rem' }}>
          ...
          <Link href="/blog" style={{ fontFamily:'var(--font-barlow-cond)', fontSize:'0.85rem', color:'var(--amber)', textDecoration:'none', letterSpacing:'0.06em', whiteSpace:'nowrap' }}>
            All Posts →
          </Link>
        </div>
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(260px,1fr))', gap:'1px', background:'var(--bdr)' }}>
