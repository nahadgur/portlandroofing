...
export const metadata: Metadata = {
  title:`Portland Roofing Services â€” Replacement, Repair, Metal, Cedar & Flat`,
  description:'All Portland roofing services. Vetted contractors across 10 deep cost markets â€” Pearl District, Hawthorne, Sellwood-Moreland, Eastmoreland, Alberta Arts, Irvington, St. Johns, West Hills, Lake Oswego, and Beaverton.',
  ...
  return (
    <>
      ...
      <PageHero
        ...
        subtitle="Five roofing service types across Portland's 10 deepest cost markets. Each market has its own bespoke pricing intelligence â€” local cost drivers, three worked examples, real permit detail."
        stats={[{label:'Service Types',value:'5'},{label:'Cost Markets',value:'10'},{label:'Avg. Response',value:'48h'}]}
      />

      {/* Services list â€” each is a Link to the service hub */}
          ...
          {services.map((s,i)=>(
            ...
            >
              <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-start',flexWrap:'wrap',gap:'1rem',marginBottom:'1rem'}}>
                <div>
                  <div style={{...m,fontSize:'0.65rem',color:'var(--amber)',letterSpacing:'0.12em',textTransform:'uppercase',marginBottom:'0.5rem'}}>${s.avgLow.toLocaleString()} â€“ ${s.avgHigh.toLocaleString()} Â· {s.unit}</div>
      ...
      {/* Cost-market navigation â€” link to neighborhood market pages */}
      <section className="section-pad" style={{background:'var(--bg)'}}>
        ...
        <p style={{...f,fontSize:'0.95rem',color:'var(--muted)',maxWidth:'640px',lineHeight:1.7,fontWeight:300,marginBottom:'2rem'}}>
          Each market page covers all five services with bespoke local cost intelligence â€” what drives quotes locally, three worked examples, real permit detail, and 5â€“6 location-specific FAQs.
        </p>
        <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fill,minmax(240px,1fr))',gap:'0.6rem'}}>
          {neighborhoods.map(n=>(
            ...
            >
              <div style={{...m,fontSize:'0.6rem',color:'var(--muted)',letterSpacing:'0.1em',textTransform:'uppercase',marginBottom:'0.35rem'}}>{n.zip} Â· {n.area}</div>
              ...
              <div style={{...m,fontSize:'0.7rem',color:'var(--muted)',marginTop:'0.4rem'}}>avg replacement Â· range {n.range}</div>
            </Link>
          ))}
        </div>
      </section>
