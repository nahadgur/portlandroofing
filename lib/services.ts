...
export const services: Service[] = [
  {
    ...
    processSteps:[
      ...
      'Sign contract with permit timeline built in, not just labor timeline',
    ...
    costDrivers:[
      ...
      { factor:"Steep pitch labor premium", impact:"+20% to 35% on labor", detail:"West Hills, Council Crest, Forest Park. 8:12+ pitch requires harness, slower pace, sometimes crane staging." },
    ...
    workedExamples:[
      ...
      },
      {
        ...
        total:"$31,380",
        note:"Premium West Hills metal upgrade. Crane day, snow guards, and steep-pitch labor together added roughly $7,500 over a flat-lot equivalent. Metal premium of roughly $14,000 over premium asphalt buys 50+ year roof life vs. 30, buyers in this tier are running lifecycle economics, not upfront cost comparisons.",
      },
    ],
    materialDeepDive:[
      {
        ...
        pros:["Most affordable full replacement option","Wide color and profile selection","25-50 year manufacturer warranties","Easiest to repair if isolated damage occurs","Compatible with most existing roof structures"],
...

  {
    ...
    materials:['Matching asphalt shingles (color-match critical on partial repairs)','Lead and aluminum flashing','Roofing cement and sealants','Ice-and-water shield for valley repairs','Synthetic underlayment'],
    ...
    costDrivers:[
      ...
      { factor:"Chimney flashing rebuild scope", impact:"+$600 to $2,400", detail:"Step + counter flashing rebuild on tall chimneys. Most common Portland repair. Lead/aluminum materials, custom-formed." },
    ...
    workedExamples:[
      {
        ...
        lineItems:[
          ...
          { label:"Counter flashing replacement (aluminum)", amount:"$280" },
    ...
    materialDeepDive:[
      ...
      {
        name:"Lead and Aluminum Step Flashing",
        priceRange:"$8-$25 per piece, $400-$900 per chimney rebuild",
        lifespan:"30-50 years for lead, 20-30 years for aluminum",
        bestFor:"Chimney step flashing, sidewall flashing, transition details",
        pros:["Lead is malleable and forms to brick/stone joints","Aluminum is corrosion-resistant and lighter","Both perform well in Portland's wet climate","Lead is heritage-appropriate on older homes"],
        cons:["Lead requires careful handling (environmental concerns)","Aluminum fasteners must match (galvanic corrosion risk)","Custom-forming requires skilled labor","Some HOAs restrict lead use"],
        pdxNote:"Most Portland chimney repairs use aluminum step flashing for cost and weight reasons. Heritage districts (Eastmoreland, Irvington) sometimes specify lead for visual match on listed properties, design review may push back on aluminum substitution.",
      },
      {
...

  {
    ...
    processSteps:[
      ...
      'In historic districts, submit color and profile samples to BDS historic review before ordering materials',
    ...
    materials:['Standing-seam panels (Galvalume, Corten, pre-painted steel)','Corrugated metal (agricultural profile, less common in residential)','Aluminum (lighter, non-corrosive, premium cost)','Copper (historic and luxury applications)','Stone-coated steel tiles (mid-range metal alternative)'],
    ...
    materialDeepDive:[
      ...
      },
      {
        ...
        pdxNote:"Aluminum is overkill for typical Portland residential applications but justified for properties in the Columbia Gorge corridor (Cascade Locks, Hood River fringe) where salt-air carries from the Columbia River. For typical Portland metro homes, Galvalume steel is the better cost-performance match.",
      },
      {
...

  {
    ...
    intro:`Cedar shake roofing in {neighborhood} occupies a specific market position: it's the material of choice for Portland's historic housing stock, required by preservation guidelines in several key neighborhoods, and genuinely beautiful when properly installed and maintained. It's also the material with the steepest learning curve for contractors and the most demanding maintenance requirements in Portland's wet climate.`,
    ...
    costDrivers:[
      ...
      { factor:"Specialist installer premium", impact:"+15% to 30% on labor", detail:"Cedar shake installation requires specific training. Generalist roofers produce installations that fail at 14-18 years. Specialist labor rates are higher." },
