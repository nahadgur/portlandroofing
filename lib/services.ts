export interface Service {
  ...
  name:         string
  shortName:    string
  headline:     string               // for H1: "[headline] in [Neighborhood]"
  description:  string               // meta description template — use {neighborhood} and {zip}
  avgLow:       number
  avgHigh:      number
  avgMid:       number
  unit:         string               // e.g. 'per project' or 'per sq ft'
  urgency:      'standard' | 'high'  // high = leak repair etc
  intro:        string               // first paragraph template, {neighborhood} injected
  whySection:   string               // second content block
  processSteps: string[]             // numbered steps
  materials:    string[]             // relevant materials for this service
  warningNote?: string               // optional callout block
}
...
export const services: Service[] = [
  {
    ...
    whySection: `Portland's Bureau of Development Services requires a permit for all full roof replacements. The complexity of that process varies significantly by neighbourhood. Understanding your permit situation before you sign a contract is the most important thing you can do to protect your timeline and your budget.`,
    processSteps: [
      ...
      'Review quotes, check contractor CCB status at oregon.gov/ccb',
  ...
  },
  {
    ...
    whySection: `Minor repairs — patching a section of shingles, re-sealing flashing, replacing a few damaged tiles — generally do not require a permit in Portland. Any repair covering more than 25% of the roof area crosses into permit territory. If you're not sure, ask before work starts. Getting this wrong means stop-work orders and potential fines.`,
    processSteps: [
      'Describe the issue through our form — active leak, wind damage, missing shingles, flashing failure',
  ...
  },
  {
    ...
    description: 'Metal roofing installation in {neighborhood}, Portland {zip}. Standing seam and corrugated metal specialists. Average cost ${avgMid}. 50+ year lifespan. Free quotes from vetted contractors.',
    avgLow:    9000,
    avgHigh:   24000,
    avgMid:    16500,
    unit:      'per project',
    urgency:   'standard',
    intro: `Metal roofing in {neighborhood} is the premium option — and on a per-year basis, typically the most cost-effective one. Portland's 144 annual rain days create a climate where metal's core advantage is decisive: instant water shedding, zero absorption, and no moss risk. A standing-seam metal roof installed in {neighborhood} this year should still be performing at 50 years. That changes the economics significantly compared to replacing asphalt twice over the same period.`,
    whySection: `The metal contractor pool in Portland is smaller than the asphalt pool. There are excellent metal roofing specialists in the metro — but there are also general roofers who've added metal to their service list without adequate training. A poorly installed standing-seam roof fails faster than asphalt. Thermal expansion allowance, panel alignment, and ridge and valley flashing details are where inexperienced installers create problems. Vet metal contractors with more scrutiny than you'd apply to an asphalt quote.`,
    processSteps: [
      'Confirm metal is appropriate for your property — pitch, structure, permit zone',
      ...
      'Confirm warranty: panel manufacturer warranty (25–40 years) separate from installer workmanship warranty',
  ...
  },
  {
    ...
    description: 'Cedar shake roofing installation and replacement in {neighborhood}, Portland {zip}. Historic district specialists. Average cost ${avgMid}. Oregon CCB-licensed contractors with documented historic experience.',
    avgLow:    11000,
    avgHigh:   19000,
    avgMid:    14500,
    unit:      'per project',
    ...
    whySection: `Portland's seven Historic Conservation Districts — including neighbourhoods like Ladd's Addition, Irvington, Alameda, and Sellwood — have varying requirements for cedar shake. In some districts, cedar replacement-in-kind is approved as routine. In others, any material change triggers a Type II Historic Resource Review regardless of whether you're replacing cedar with cedar. Confirm your property's specific requirements before signing anything.`,
    processSteps: [
      ...
      'Confirm contractor has documented cedar shake installation experience and references in Portland',
  ...
  },
  {
    ...
    description: 'Flat roof replacement and TPO installation in {neighborhood}, Portland {zip}. Commercial and residential flat roofing specialists. Average cost ${avgMid}. Free assessment for active leaks.',
    avgLow:    5500,
    avgHigh:   12000,
    avgMid:    7800,
    unit:      'per project',
    ...
    processSteps: [
      ...
      'For commercial properties: confirm commercial permit class vs residential permit',
    ...
    warningNote: 'In Portland, flat roofs require correct drainage slope — minimum 1/4 inch per foot to drains. Flat is never truly flat. A roof that drains to ponding water (standing water 48 hours after rain) is failing. This should be addressed as part of any membrane replacement, not after.',
  },
]
