...
export default function Hero({ children }: Props) {
  return (
    <div className="hero-wrap">
      ...
      {/* ── HOMEPAGE HERO IMAGE — priority=true → preloaded as LCP ── */}
      <Image
        src="/images/hero-homepage.webp"
        alt="Portland craftsman home at golden hour"
        fill
        priority            // tells browser to fetch this before anything else
        quality={90}
        sizes="100vw"
        style={{ objectFit:'cover', objectPosition:'center 30%' }}
      />

      {/* Gradient: heavy left for text, light right for form card */}
      <div style={{
      ...
      {/* Content grid */}
      <div className="hero-content" style={{ position:'relative', zIndex:2, isolation:'isolate' }}>
