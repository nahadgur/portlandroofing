...
interface PageHeroProps {
  ...
  tall?:       boolean
  imageUrl?:   string
  priority?:   boolean   // true for pages where this IS the LCP element
}
...
export default function PageHero({
  ...
  return (
    <div style={{ position:'relative', overflow:'hidden', borderBottom:'1px solid var(--bdr)' }}>
      ...
      {/* ── HERO IMAGE via Next.js Image (LCP optimised) ── */}
      <Image
        src={src}
        alt=""
        fill
      ...
      <div style={{
        ...
        display:'grid',
        gridTemplateColumns: right ? 'clamp(200px, 1fr, 1fr) min(460px, 42vw)' : '1fr',
        minHeight: minH,
